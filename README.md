# MovieApi
## TODO: Felsöka /api/Movies/{movieId}/actors/{actorId}? Maybe it was just that I killed the server :D
-- Move to ActorsController? 

## Todo Normalize the Movie table by breaking out the genre and director into separate tables
